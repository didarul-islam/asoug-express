<template>
  <!-- form -->
  <div class="card">
    <div class="card-header"><h3 class="mt-1">Add Brand</h3></div>
    <hr />
    <div class="card-body">
  ...
  methods: {
    ...
    setBrandData: function () {
      axios
        ...
        .then((resp) => {
          this.CategoryAll = resp.data.CategoryAll;
          for (var i = 0; i < this.CategoryAll.length; i++) {
            var option = [];
            for (var key in this.CategoryAll[i]) {
              if (key == "id") {
                option["value"] = this.CategoryAll[i][key];
              } else if (key == "name") {
                option["text"] = this.CategoryAll[i][key];
              }
            }
    ...
    brandAdd() {
      ...
      formData.append("category_id", this.CategoryAll);
      console.log(formData);
      this.$http
        .post("admin/v1/brand", formData)
        .then((response) => {
