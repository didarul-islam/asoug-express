      ...
      >
        <template slot="table-row" slot-scope="props">
          ...
          <span
            ...
            class="text-nowrap"
          >
            <span v-if="props.row.parent != null" class="text-nowrap">
              {{ props.row.parent.name }}</span
            >
            <span v-else class="text-nowrap"> Parent Category</span>
          </span>
...
export default {
  ...
  methods: {
    categoryData() {
      this.$http.get("admin/v1/category").then((res) => {
